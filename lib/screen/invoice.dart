...
class _InvoiceState extends State<Invoice> {
  ...
  SingleSelectController<Customer> namecon = SingleSelectController<Customer>(null);
      SingleSelectController<String> categorycon = SingleSelectController<String>(null);
  SingleSelectController<Product> productcon = SingleSelectController<Product>(null);
