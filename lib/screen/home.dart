                                    ...
                                    builder: (context, snapayi) {
                                      return FutureBuilder<List<int>>(
                                        ...
                                        builder: (context, snapscr) {
                                          ...
                                          if (hasdata) {
                                            int screen=snapscr.data![0], page = snapscr.data![1];
                                            return Row(
