...
class ProductPage extends StatelessWidget {
  ProductPage({super.key, required this.page, required this.prodata});
  ...
  Widget build(BuildContext context) {
    return Builder(builder: (con) {
      if (page == 1) {
        return ViewProduct(prodata: prodata,);
      } else if (page == 2) {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Container(
        ...
        child: Padding(
          padding: EdgeInsetsDirectional.fromSTEB(10.w, 0.0, 10.w, 0.0),
          child: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                Padding(
                  padding:
                  EdgeInsetsDirectional.fromSTEB(0.0, 16.h, 0.0, 0.0),
                  child: Container(
                    width: double.infinity,
...
class _ViewProductState extends State<ViewProduct> {
  ...
  @override
  Widget build(BuildContext context) {
    List<Product> data = widget.prodata;
        ...
        child: Row(
          ...
          children: [
            Expanded(
              ...
              child: Padding(
                padding:
                EdgeInsetsDirectional.fromSTEB(10.w, 0.0, 0.0, 0.0),
                child: Text(
                  product.categname,
...
class ViewProduct extends StatefulWidget {
  ViewProduct({super.key, required this.prodata});
  List<Product> prodata;
