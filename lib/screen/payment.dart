...
class _AddPaymentOutState extends State<AddPaymentOut>
    with TickerProviderStateMixin {
  TextEditingController amountreceivedcon = TextEditingController(),
      amountadjustmentcon = TextEditingController(),
      notescon = TextEditingController();
...
class _ViewPaymentOutState extends State<ViewPaymentOut> {
  TextEditingController textController = TextEditingController();
  FocusNode textFieldFocusNode = FocusNode();
                      ...
                      child: FFButtonWidget(
                        onPressed: () {
                          showDialog(
                              context: context,
                              builder: (con) {
                                return AddPaymentOut(bildata: widget.bildata, cusdata: widget.cusdata);
                              },
                          );
                        },
                        text: 'Pay In',
...
class _EditPaymentOutState extends State<EditPaymentOut>
    with TickerProviderStateMixin {
  TextEditingController namecon = TextEditingController(),
      billnocon = TextEditingController(),
      datecon = TextEditingController(),
...
class ViewPaymentOut extends StatefulWidget {
  ViewPaymentOut({super.key, required this.paydata, required this.cusdata, required this.bildata});
  List<Customer> cusdata;
  List<Payment> paydata;
  List<Bill> bildata;

  @override
  State<ViewPaymentOut> createState() => _ViewPaymentOutState();
}

class PaymentOutList extends StatefulWidget {
  PaymentOutList({super.key, required this.paymentout, required this.cusdata});
  List<Customer> cusdata;
  Payment paymentout;
...
class EditPaymentOut extends StatefulWidget {
  const EditPaymentOut({super.key});

  @override
  State<EditPaymentOut> createState() => _EditPaymentOutState();
}

class AddPaymentOut extends StatefulWidget {
  AddPaymentOut({super.key, required this.bildata, required this.cusdata});
  List<Bill> bildata;
  List<Customer> cusdata;

  @override
  State<AddPaymentOut> createState() => _AddPaymentOutState();
}
